...
import { simularPagoAction, simularPedidoAction } from "../../../actions/simulacion"; 
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 bg-black/95 border-2 border-primary/20 rounded-2xl p-6 flex flex-col min-h-[35vh] md:min-h-auto shadow-xl relative overflow-hidden before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top,rgba(var(--primary-rgb),0.08),transparent_60%)] pointer-events-none before:pointer-events-none">
          ...
          {/* El contenedor de logs ahora si permite scroll */}
          <div className="flex-1 overflow-y-auto font-mono text-[11px] text-emerald-400 space-y-2 max-h-[340px] md:max-h-none pointer-events-auto selection:bg-emerald-500/30">
            {consolaLog.length === 0 ? (
